...
export const PhotographyGraphicDesigningContentCreation: CollectionConfig = {
    slug: 'photography-graphic-designing-content-creation',
    admin: {
        useAsTitle: 'title',
    },
    access: {
    ...
    fields: [
        ...
        },
        {
            ...
            type: 'array',
            label: 'Creative Services Features',
            fields: [
                {
                    name: 'featureTitle',
                    type: 'text',
