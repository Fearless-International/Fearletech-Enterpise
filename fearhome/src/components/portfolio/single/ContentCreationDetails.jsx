...
function ContentCreationDetails() {
                ...
                {loading ? (
                    ...
                    <>
                        ...
                        <div className="pagination-controls">
                            ...
                            <button
                                className="pagination-button"
                                disabled={currentPage === Math.ceil(projects.length / itemsPerPage) || paginatedProjects.length === 0 || loading}
                                onClick={() => setCurrentPage((prev) => prev + 1)}
                            >
                                Next
                            </button>
...
export default ContentCreationDetails;
