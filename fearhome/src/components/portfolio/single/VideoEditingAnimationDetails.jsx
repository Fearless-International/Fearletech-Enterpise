...
function VideoEditingAnimationDetails() {
    ...
    setError(null);
    try {
        const response = await payloadClient.getVideoEditingAnimationProjects(currentPage);
...
export default VideoEditingAnimationDetails;