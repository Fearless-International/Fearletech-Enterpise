          ...
          <div className="d-flex align-items-center mb-30">
            <h2 className="fw-600 fz-70 text-u d-rotate wow">
              <span className="rotate-text">
                Design <span className="fw-200">Workflow</span>
              </span>
            </h2>
        ...
        <div className="row">
          <div className="col-lg-3 col-md-6">
            <div className="item-box radius-15 md-mb50">
              ...
              <h6 className="mb-20">Research & Analysis</h6>
              <p>
                Understanding user needs through research and competitive analysis.
              </p>
            </div>
          </div>
          <div className="col-lg-3 col-md-6">
            <div className="item-box radius-15 md-mb50">
              ...
              <h6 className="mb-20">Wireframing</h6>
              <p>
                Creating low-fidelity wireframes to map user flows and interactions.
              </p>
            </div>
          </div>
          <div className="col-lg-3 col-md-6">
            <div className="item-box radius-15 sm-mb50">
              ...
              <h6 className="mb-20">Visual Design</h6>
              <p>
                Crafting beautiful high-fidelity designs with perfect attention to detail.
              </p>
            </div>
          </div>
          <div className="col-lg-3 col-md-6">
            <div className="item-box radius-15">
              ...
              <h6 className="mb-20">Testing & Iteration</h6>
              <p>
